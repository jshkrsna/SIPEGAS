...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('pengguna', function (Blueprint $table) {
            ...
            $table->enum('role', ['pegawai', 'admin', 'kepala_sekolah', 'yayasan'])->default('pegawai');
            $table->string('foto_profil_url', 500)->nullable()->comment('URL Minio storage');
            $table->string('qr_token', 100)->nullable()->unique()->comment('NULL untuk non-pegawai. UNIQUE multi-NULL diizinkan MySQL');
