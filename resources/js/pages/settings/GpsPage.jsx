    ...
    return (
        <div className="p-6 max-w-3xl mx-auto">
            <div className="mb-6 flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-white">Lokasi GPS Presensi</h2>
                    <p className="text-slate-400 text-sm mt-1">Titik lokasi valid untuk check-in geofencing</p>
                </div>
